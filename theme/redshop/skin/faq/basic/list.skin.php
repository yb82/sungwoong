...
<div id="faq_wrap" class="faq_<?php echo $fm_id; ?>">
    ...
    <section id="faq_con">
        ...
        <ol>
            ...
            ?>
            <li>
                <h3><a href="#none" onclick="return faq_open(this);"><span class="faq_f">질문</span> <?php echo conv_content($v['fa_subject'], 1); ?></a></h3>
                <div class="con_inner">
                    <span class="faq_q">답변</span><?php echo conv_content($v['fa_content'], 1); ?>
...
<fieldset id="faq_sch">
    ...
    <input type="text" name="stx" value="<?php echo $stx;?>" required id="stx" class="frm_input required" size="25" maxlength="15">
