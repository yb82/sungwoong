    ...
    ?>
        ...
        <li class="sit_use_li">
            ...
            <dl class="sit_use_dl">
                ...
                <dd><span class="st_bg"></span><?php echo $is_time; ?></dd>
                <dt class="sound_only">평점<dt>
                <dd class="sit_use_star"><span class="st_bg"></span><img src="<?php echo G5_SHOP_URL; ?>/img/s_star<?php echo $is_star; ?>.png" alt="별<?php echo $is_star; ?>개"></dd>
            </dl>
