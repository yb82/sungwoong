...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov">
        ...
        <div id="sit_star">
            <?php if ($star_score) { ?>
            <span class="sound_only">고객평점 <?php echo $star_score?>점</span>
        ...
        <section id="sit_sel_option">
            ...
            <ul id="sit_opt_added">
                <li class="sit_opt_list">
                    ...
                    <span class="sit_opt_prc">(+AUD 0)</span>
                    <div>
        ...
        <div id="sit_ov_btn">
            ...
            <a href="javascript:popup_stocksms('<?php echo $it['it_id']; ?>');" id="sit_btn_sms">재입고알림</a>
            <?php } ?>
        ...
        <?php
        $ev_data = get_item_event_info($it['it_id']);

        if(!empty($ev_data)) {
        ?>
        <div id="sit_event">
            <h2><span class="tit_bullet"></span>관련이벤트</h2>
            <ul>
            <?php
            foreach($ev_data as $val) {
                $href = G5_SHOP_URL.'/event.php?ev_id='.$val['ev_id'];
            ?>
                <li><a href="<?php echo $href; ?>"><img src="<?php echo $val['img']; ?>"></a></li>
            <?php
            }
            ?>
            </ul>
