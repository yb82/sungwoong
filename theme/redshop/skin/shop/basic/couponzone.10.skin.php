...
<section class="couponzone_list">
    ...
    for($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        $coupon .= '<div class="coupon_btn"><button type="button" class="coupon_download btn02'.$disabled.'" data-cid="'.$row['cz_id'].'"><i class="fa fa-download" aria-hidden="true"></i> 쿠폰다운로드</button></div>'.PHP_EOL;
        $coupon .= '</li>'.PHP_EOL;
    }
