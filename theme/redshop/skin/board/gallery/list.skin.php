...
<h2 id="wrapper_title"><?php echo $board['bo_subject'] ?><span class="sound_only"> 목록</span></h2>
...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul">
        <?php for ($i=0; $i<count($list); $i++) {
         ...
         ?>
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>">
            <?php if ($is_checkbox) { ?>
            ...
            <ul class="gall_con">
                ...
                <li><span class="sound_only">작성일 </span><?php echo $list[$i]['datetime2'] ?></li>
