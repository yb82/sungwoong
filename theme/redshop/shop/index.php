...
<section class="bosection">
    <section style="float: left; width: 23% ;margin-right: 20px">
    ...
    <section style="width: 23%;margin-right: 40px;">
        <?php echo latest('theme/shop_basic', 'qa', 5, 20); ?>
    </section>
<section  style="width: 20%">
    <div style="width:185px;height:auto;border:1px solid #C92033;text-align:center;font-size:13px;font-family:sans-serif,Arial,Helvetica;border-top-right-radius:5px; border-top-left-radius:5px;background-color:#FFFFFF;"><div style="width:100%; height:24px;padding:5px 0px 0px 0px;background-color:#C92033;font-weight:bold;"><a rel="nofollow" style="color:#FFFFFF;text-decoration:none;" href="http://www.fxexchangerate.com/">환율계산기</a></div><script type="text/javascript" src="http://w.fxexchangerate.com/converter.php?fm=AUD&ft=KRW&lg=en&am=1&ty=1"></script></div> 
</section>
</section>
