...
$theme_config = array(
    ...
    'bo_gallery_width'              => 220,     // 갤러리 이미지 폭
    ...
    'de_type1_img_width'            => 325,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 325,     // PC 히트상품 이미지 높이
    ...
    'de_type2_img_width'            => 325,     // PC 추천상품 이미지 폭
    'de_type2_img_height'           => 325,     // PC 추천상품 이미지 높이
    ...
    'de_type3_img_width'            => 325,     // PC 최신상품 이미지 폭
    'de_type3_img_height'           => 325,     // PC 최신상품 이미지 높이
    ...
    'de_type4_img_width'            => 175,     // PC 인기상품 이미지 폭
    'de_type4_img_height'           => 175,     // PC 인기상품 이미지 높이
    ...
    'de_type5_img_width'            => 325,     // PC 할인상품 이미지 폭
    'de_type5_img_height'           => 325,     // PC 할인상품 이미지 높이
    ...
    'de_rel_img_width'              => 145,     // 관련상품 이미지 폭
    'de_rel_img_height'             => 145,     // 관련상품 이미지 높이
    ...
    'de_search_list_mod'            => 3,       // 검색상품 1줄당 이미지 수
    'de_search_list_row'            => 5,       // 검색상품 출력 줄 수
    'de_search_img_width'           => 325,     // 검색상품 이미지 폭
    'de_search_img_height'          => 325,     // 검색상품 이미지 높이
    ...
    'de_mimg_width'                 => 545,     // 상품상세 이미지 Width
    'de_mimg_height'                => 545,     // 상품상세 이미지 Height
    'ca_skin'                       => 'list.10.skin.php',  // 분류 리스트 스킨
    'ca_img_width'                  => 325,     // 분류 리스트 이미지 폭
    'ca_img_height'                 => 325,     // 분류 리스트 이미지 높이
    'ca_list_mod'                   => 3,       // 분류 리스트 1줄당 이미지 수
    'ca_list_row'                   => 5,       // 분류 리스트 이미지 줄 수
    'ca_mobile_skin'                => 'list.10.skin.php',  // 모바일 분류 리스트 스킨
    'ca_mobile_img_width'           => 325,     // 모바일 분류 리스트 이미지 폭
    'ca_mobile_img_height'          => 325,     // 모바일 분류 리스트 이미지 높이
    'ca_mobile_list_mod'            => 2,       // 모바일 분류 리스트 1줄당 이미지 수
    'ca_mobile_list_row'            => 4,       // 모바일 분류 리스트 이미지 줄 수
    'ev_skin'                       => 'list.10.skin.php',  // 이벤트 출력 스킨
    'ev_img_width'                  => 325,     // 이벤트 리스트 이미지 폭
    'ev_img_height'                 => 325,     // 이벤트 리스트 이미지 높이
