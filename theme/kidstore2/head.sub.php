...
<?php
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/bootstrap.min.css">', -100);
?>
...
<script src="<?php echo G5_THEME_JS_URL ?>/jquery-1.11.3.min.js"></script>
...
<script src="<?php echo G5_THEME_JS_URL ?>/scripts.js"></script>
