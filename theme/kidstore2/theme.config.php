...
$theme_config = array(
    ...
    'de_type1_img_width'            => 238,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 238,     // PC 히트상품 이미지 높이
    ...
    'de_type2_img_width'            => 238,     // PC 추천상품 이미지 폭
    'de_type2_img_height'           => 238,     // PC 추천상품 이미지 높이
    ...
    'de_type3_img_width'            => 238,     // PC 최신상품 이미지 폭
    'de_type3_img_height'           => 238,     // PC 최신상품 이미지 높이
    ...
    'de_type4_img_width'            => 238,     // PC 인기상품 이미지 폭
    'de_type4_img_height'           => 238,     // PC 인기상품 이미지 높이
    ...
    'de_type5_img_width'            => 238,     // PC 할인상품 이미지 폭
    'de_type5_img_height'           => 238,     // PC 할인상품 이미지 높이
    ...
    'de_mobile_type1_img_width'     => 238,     // 모바일 히트상품 이미지 폭
    'de_mobile_type1_img_height'    => 238,     // 모바일 히트상품 이미지 높이
    'de_mobile_type2_list_use'      => 1,       // 모바일 추천상품 출력
    'de_mobile_type2_list_skin'     => '4main.10.skin.php', // 모바일 추천상품 출력스킨
    'de_mobile_type2_list_mod'      => 3,       // 모바일 추천상품 출력 1줄당 이미지 수
    'de_mobile_type2_list_row'      => 2,       // 모바일 추천상품 출력 출력 줄 수
    'de_mobile_type2_img_width'     => 238,     // 모바일 추천상품 이미지 폭
    'de_mobile_type2_img_height'    => 238,     // 모바일 추천상품 이미지 높이
    ...
    'de_mobile_type3_img_width'     => 238,     // 모바일 최신상품 이미지 폭
    'de_mobile_type3_img_height'    => 238,     // 모바일 최신상품 이미지 높이
    ...
    'de_mobile_type4_img_width'     => 238,     // 모바일 인기상품 이미지 폭
    'de_mobile_type4_img_height'    => 238,     // 모바일 인기상품 이미지 높이
    ...
    'de_mobile_type5_img_width'     => 238,     // 모바일 할인상품 이미지 폭
    'de_mobile_type5_img_height'    => 238,     // 모바일 할인상품 이미지 높이
    'de_rel_list_use'               => 1,       // 관련상품 출력
    'de_rel_list_skin'              => 'relation.10.skin.php',  // 관련상품 출력 스킨
    'de_rel_list_mod'               => 4,       // 관련상품 1줄당 이미지 수
    'de_rel_img_width'              => 238,     // 관련상품 이미지 폭
    'de_rel_img_height'             => 238,     // 관련상품 이미지 높이
    ...
    'de_mobile_rel_img_width'       => 238,     // 모바일 관련상품 이미지 폭
    'de_mobile_rel_img_height'      => 238,     // 모바일 관련상품 이미지 높이
    'de_search_list_skin'           => 'list.10.skin.php',  // 검색상품 출력 스킨
    'de_search_list_mod'            => 4,       // 검색상품 1줄당 이미지 수
    'de_search_list_row'            => 4,       // 검색상품 출력 줄 수
    'de_search_img_width'           => 238,     // 검색상품 이미지 폭
    'de_search_img_height'          => 238,     // 검색상품 이미지 높이
    ...
    'de_mobile_search_img_width'    => 238,     // 모바일 관련상품 이미지 폭
    'de_mobile_search_img_height'   => 238,     // 모바일 관련상품 이미지 높이
    'de_mimg_width'                 => 238,     // 상품상세 이미지 Width
    'de_mimg_height'                => 238,     // 상품상세 이미지 Height
    ...
    'ev_img_width'                  => 238,     // 이벤트 리스트 이미지 폭
    'ev_img_height'                 => 238,     // 이벤트 리스트 이미지 높이
    'ev_list_mod'                   => 4,       // 이벤트 리스트 1줄당 이미지 수
    'ev_list_row'                   => 4,       // 이벤트 리스트 이미지 줄 수
    'ev_mobile_skin'                => 'list.10.skin.php',  // 모바일 이벤트 출력 스킨
    'ev_mobile_img_width'           => 238,     // 모바일 이벤트 리스트 이미지 폭
    'ev_mobile_img_height'          => 238,     // 모바일 이벤트 리스트 이미지 높이
    'ev_mobile_list_mod'            => 4,       // 모바일 이벤트 1줄당 이미지 수
    'ev_mobile_list_row'            => 4,       // 모바일 이벤트 이미지 줄 수
    'ca_mobile_list_best_mod'       => 4,       // 모바일 상품리스트 베스트상품 1줄당 이미지 수
    'ca_mobile_list_best_row'       => 4,       // 모바일 상품리스트 베스트상품 이미지 줄 수
);
