...
sql_query("
    alter table {$g5['g5_shop_default_table']}
        ...
        add `de_weit_cost` float not null default 0,
        add `de_weit_cost_add` float not null default 0
", true);
...
sql_query("
    alter table {$g5['g5_shop_order_table']}
        ...
        add `od_weit_cost` float not null default 0,
        add `de_weit_g` float not null default 0,
        add `de_weit_cost` float not null default 0,
        add `de_weit_cost_add` float not null default 0
", true);
